...
def Run(singleTraining=True):
    ...
    if singleTraining:
        ...
        TunerTraining(ModelLRMU_SimpleRNN_Tuning, "LRMU_RNN_tuning_15k", PROBLEM_NAME, training, validation, 5, 100,
                      False)
        TunerTraining(ModelLRMU_ESN_stack_Tuning, "LRMU_RNN_Stack_tuning_15k", PROBLEM_NAME, training, validation, 5, 100,
                      False)
        TunerTraining(ModelLRMU_SimpleRNN_stack_Tuning, "LRMU_RNN_Stack_tuning_15k", PROBLEM_NAME, training, validation, 5, 100,
                      False)
